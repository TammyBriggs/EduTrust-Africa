        ...
        {activeTab === "verify" && (
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl transition-all duration-500">
            <form onSubmit={handleVerify} className="flex flex-col gap-4">
              ...
              <input type="text" placeholder="Paste raw SHA-256 hash (0x...)" value={verifyHash} onChange={(e) => setVerifyHash(e.target.value)} className="w-full bg-black/40 border border-white/10 rounded-xl px-5 py-4 mb-6 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-accentCyan/50 transition-all duration-300" />
